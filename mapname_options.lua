...

{
    ...
    values = {
        ...
        -- { text = "2v2" .. "<LOC adaptive_dynamic_spawn_key_4_label> setup", help = "<LOC adaptive_dynamic_spawn_key_4_help> Don't adjust for player & spawn resources for " .. "2v2.", key = 4, },
        -- { text = "4v4" .. "<LOC adaptive_dynamic_spawn_key_4_label> setup", help = "<LOC adaptive_dynamic_spawn_key_4_help> Don't adjust for player & spawn resources for " .. "4v4.", key = 5, },
        -- { text = "6v6" .. "<LOC adaptive_dynamic_spawn_key_4_label> setup", help = "<LOC adaptive_dynamic_spawn_key_4_help> Don't adjust for player & spawn resources for " .. "6v6.", key = 6, },
        -- { text = "8v8" .. "<LOC adaptive_dynamic_spawn_key_4_label> setup", help = "<LOC adaptive_dynamic_spawn_key_5_help> Don't adjust for player & spawn resources for maximum player count.", key = 7, },
    },
},
...

{
    ...
    pref = 'extra_mexes',
    values = {
        { text = "0", help = "<LOC adaptive_extra_mex_key_1_help> No extra mexes.", key = 1, },
        { text = "4", help = "Spawn 4 mexes.", key = 2, },
    },
},

{
    ...
    pref = 'middle_mexes',
    values = {
        { text = "0", help = "<LOC adaptive_middle_mex_key_1_help> No additional mexes in the middle.", key = 1, }
        { text = "2", help = "<LOC adaptive_middle_mex_key_2_help> Spawn 2 mexes in the middle.", key = 2, },
        { text = "4", help = "<LOC adaptive_middle_mex_key_3_help> Spawn 4 mexes in the middle.", key = 3, },
        { text = "6", help = "<LOC adaptive_middle_mex_key_4_help> Spawn 6 mexes in the middle.", key = 4, },
    },
},
